...
[Command]
name = "Tripluigi Time"   ;Same name as above
command = ~D, DF, F, D, DF, F, y
time = 20
...
[Command]
name = "Hyper Hammer"   ;Same name as above
...
;---------------------------------------------------------------------------
;Hyper Hammer
[State -1, Hyper Hammer]
type = ChangeState
value = 3050
triggerall = command = "Hyper Hammer"
...
;---------------------------------------------------------------------------
;Tripluigi Time
[State -1, Tripluigi Time]
type = ChangeState
value = 3000
triggerall = command = "Tripluigi Time"
triggerall = power >= 3000
...
triggerall = statetype != A
trigger1 = statetype = S
trigger1 = command = "Assist - Wario"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Assist - Bob-omb
[State -1, Assist - Bob-omb]
type = ChangeState
value = 1002
triggerall = numhelper(1001) = 0
triggerall = statetype != A
trigger1 = statetype = S
trigger1 = command = "Assist - Bob-omb"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Rope swatter
[State -1, Rope swatter]
type = ChangeState
value = 1005
triggerall = ctrl
triggerall = statetype != A
triggerall = power >= 1000
trigger1 = command = "Rope swatter"
trigger2 = var(7) = 1
trigger2 = random > 979
...
triggerall = statetype != A
triggerall = power >= 1000
trigger1 = command = "Spinning Kick"
trigger2 = var(7) = 1
trigger2 = random > 979

;---------------------------------------------------------------------------
; Air Spinning Kick
[State -1, Air Spinning Kick]
type = ChangeState
value = 1007
triggerall = ctrl
...
;---------------------------------------------------------------------------
; Super Hammer
[State -1, Super Hammer]
type = ChangeState
value = 1008
triggerall = ctrl
triggerall = statetype != A
triggerall = power >= 1000
trigger1 = command = "Super Hammer"
trigger2 = var(7) = 1
trigger2 = random > 979
